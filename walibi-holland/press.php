...
echo "<channel>\n";
echo "<title>Walibi Holland Nieuws</title>\n";
echo "<link>$url</link>\n";
echo "<description>Laatste nieuws en updates van Walibi Holland</description>\n";
echo '<atom:link href="https://rss.nielskooyman.io/walibi-holland" rel="self" type="application/rss+xml" />';
...
foreach ($articles as $article) {
    ...
    $link = $linkNode->length > 0 ? "https://pers.walibi.nl" . $linkNode->item(0)->getAttribute("href") : "#";
